...
class DanceTrackCOCOHP(data.Dataset):
    num_classes = 1
    num_joints = 17
    ...
    def __init__(self, opt, split):
        super(DanceTrackCOCOHP, self).__init__()
        ...
        self.data_dir = os.path.join(opt.data_dir, 'dancetrack_coco_hp')
        ...
        print('==> initializing dancetrack_coco_hp {} data.'.format(split))
