...
class DanceTrackCOCO(data.Dataset):
    num_classes = 80
    ...
    def __init__(self, opt, split):
        super(DanceTrackCOCO, self).__init__()
        self.data_dir = os.path.join(opt.data_dir, 'dancetrack_coco')
        ...
        print('==> initializing dancetrack_coco {} data.'.format(split))
