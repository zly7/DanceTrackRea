...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('task', default='ctdet',
                                 help='ctdet | ctseg | ddd | multi_pose | exdet | tracking or combined with')
        self.parser.add_argument('--dataset', default='coco',
                                 help='dancetrack | coco | kitti | coco_hp | pascal')
        ...
        self.parser.add_argument('--load_model_traj', default='', 
                                 help="path to pretrained model_traj")
        ...
        self.parser.add_argument('--trainval', action='store_true',
                                 help='include validation in training and '
                                      'test on test set')
        self.parser.add_argument('--remove_black', action='store_true',
                                 help='avoid big padding when joint-training of dancetrack and kitti')
        # test
        ...
        self.parser.add_argument('--out_size', type=int, default=-1)
        ...
        self.parser.add_argument('--seg_weight', default=3., type=float,
                                 help='')
        self.parser.add_argument('--mask_thresh', default=0.5, type=float,
                                 help='conf_threshold to mask')
        # exdet
        ...
        self.parser.add_argument('--buffer_size', type=int, default=30,
                                help='the number of frames the unmatched tracklet is kept for')
        self.parser.add_argument('--out_thresh', type=int, default=0.2,
                                help='low score threshold in BYTE association')
        self.parser.add_argument('--track_thresh', type=float, default=0.4,
                                help='high score threshold in BYTE association')
        self.parser.add_argument('--new_thresh', type=float, default=0.4,
                                help='score threshold to start a new tracklet')                                 
        self.parser.add_argument('--match_thresh', type=float, default=0.8)
        self.parser.add_argument('--fuse_mask', action='store_true',
                                help='whether fuse mask similarity to associcate')
        self.parser.add_argument('--fast_mask', action='store_true',
                                help='whether not use mask post-process to speed up')
        self.parser.add_argument('--fuse_pose', action='store_true',
                                help='whether fuse pose similarity to associcate')
        self.parser.add_argument('--fuse_depth', action='store_true',
                                help='whether fuse depth similarity to associcate')
        self.parser.add_argument('--lstm', action='store_true',
                                help='whether use lstm to predict the trajectory')
