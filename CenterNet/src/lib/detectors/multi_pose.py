...
#                     debugger.add_coco_bbox(bbox, 0, score, track_id=tracking_id, img_id='multi_pose')
                    debugger.add_coco_hp(hps, track_id=tracking_id, img_id='multi_pose')
        else:
        ...
        if self.opt.debug == 4:
            ...
            debugger.save_all_imgs(self.opt.debug_dir, prefix='{}'.format(self.cnt), specific='multi_pose')
        else:
