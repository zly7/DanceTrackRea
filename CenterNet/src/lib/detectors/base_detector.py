...
# from trackers.tracker_iou import Tracker
# from trackers.tracker_kalman import Tracker
# from trackers.tracker_lstm import Tracker
from trackers.tracker_byte import Tracker
...
class BaseDetector(object):
    def __init__(self, opt):
        ...
        self.debugger = Debugger(opt=opt, dataset=self.opt.dataset, ipynb=(self.opt.debug == 3),
...
#                 self.debug(self.debugger, images, dets, output, scale)
        ...
        if self.opt.tracking:
            ...
            results = self.tracker.step(results)
